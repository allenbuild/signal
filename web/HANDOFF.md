...
This handoff records source behavior and known gaps. It does not claim a public
deployment, live provider call, production database, native execution, or
published release.
...
7. No native artifact, public checksum, signing, notarization, Gatekeeper, or
   physical gesture evidence is available from this web handoff.
