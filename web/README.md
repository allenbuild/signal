...
- the configured public URL is
  <https://signal-hand-control.allenxtech.chatgpt.site>, but its deployed Sites
  version predates the integrated merge;
- Vercel CLI authentication is unavailable on this machine;
- `.openai/hosting.json` persists Sites project
  `appgprj_6a6422c8db288191a17d8b43fb81efa5` and D1 binding `DB`;
